...
function activate(context) {
	...
	let disposable1 = vscode.commands.registerCommand('hellovsc.captureCursor', function () {
	...
	let disposable2 = vscode.commands.registerCommand('hellovsc.actiavteCursors', function () {
